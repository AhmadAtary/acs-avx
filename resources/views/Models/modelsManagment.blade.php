    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="col-12 mt-3">
                <label class="form-label">Upload Data Model (CSV)</label>
                <input type="file" name="data_model_file" accept=".csv" class="form-control">
                <small class="text-muted">
                    <a href="{{ asset('storage/data_model_template.csv') }}" download class="text-gray-600">
                        Download Template
                    </a>
                </small>
            </div>
